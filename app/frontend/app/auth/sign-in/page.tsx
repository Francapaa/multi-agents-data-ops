        ...
        <div className="bg-white rounded-2xl shadow-xl border border-blue-100 p-8">
          ...
          <form action={formAction} className="space-y-5">
            ...
            <motion.button
              ...
              className="w-full py-3 px-4 bg-white hover:bg-gray-50 text-gray-700 font-semibold rounded-lg border border-gray-200 transition-all duration-200 flex items-center justify-center gap-2"
            >
              <svg className="w-5 h-5" viewBox="0 0 24 24">
                ...
                <path
                  fill="#34A853"
                  d="M12 23c2.97 0 5.46-.98 7.28-2.63l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.96 20.53 7.7 23 12 23z"
                />
                <path
                  fill="#FBBC05"
